...
const Rootlayout = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full max-w-[600px] mx-auto">
      ...
      <div
        className={`w-full py-2 text-white text-xs bg-[${bgColor}] backdrop-blur-md w-full flex items-center sticky bottom-0 border-t border-slate-100 dark:border-black/20 `}
      >
